            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <form @submit.prevent="submit" class="px-8 pt-6 pb-8 mb-4">
                        ...
                        <Link class="ml-4 btn btn-danger float-right cursor-pointer" @click="cleanForm"
...
import { Inertia } from '@inertiajs/inertia'
 ...
 export default defineComponent({
        ...
        data(){
            return {
               form:{
                    name:"Margaret FLorencia",
                    email:"mflorencia@gmail.com",
                    password:"123456"
               }
            }
        },
        methods:{
           submit(){
            ...
            //    }))
               Inertia.post(route('userList.store'),this.form)
           },
           cleanForm: function(){
               this.form.name ="";
               this.form.email ="";
